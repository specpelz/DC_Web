...
const AirReadingDetails = () => {
 ...
 console.log(item," Calling you Ole")
  ...
  const aqr_days = [
    {
      ...
      day: moment(item.histories[0].date).format("dddd"),
      date: moment(item.histories[0].date).format("DD"),
      month: moment(item.histories[0].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[1].aqi: "No data",
      day: moment(item.histories[1].date).format("dddd"),
      date: moment(item.histories[1].date).format("DD"),
      month: moment(item.histories[1].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[2].aqi: "No data",
      day: moment(item.histories[2].date).format("dddd"),
      date: moment(item.histories[2].date).format("DD"),
      month: moment(item.histories[2].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[3].aqi: "No data",
      day: moment(item.histories[3].date).format("dddd"),
      date: moment(item.histories[3].date).format("DD"),
      month: moment(item.histories[3].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[4].aqi: "No data",
      day: moment(item.histories[4].date).format("dddd"),
      date: moment(item.histories[4].date).format("DD"),
      month: moment(item.histories[4].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[5].aqi: "No data",
      day: moment(item.histories[5].date).format("dddd"),
      date: moment(item.histories[5].date).format("DD"),
      month: moment(item.histories[5].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[6].aqi: "No data",
      day: moment(item.histories[6].date).format("dddd"),
      date: moment(item.histories[6].date).format("DD"),
      month: moment(item.histories[6].date).format("MMMM"),
    },
  ...
  const pm1 =[
    ...
    {
      value: item.histories.length > 0 ? item.histories[1].pm1_0: "No data",
      day: moment(item.histories[1].date).format("dddd"),
      date: moment(item.histories[1].date).format("DD"),
      month: moment(item.histories[1].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[2].pm1_0: "No data",
      day: moment(item.histories[2].date).format("dddd"),
      date: moment(item.histories[2].date).format("DD"),
      month: moment(item.histories[2].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[3].pm1_0: "No data",
      day: moment(item.histories[3].date).format("dddd"),
      date: moment(item.histories[3].date).format("DD"),
      month: moment(item.histories[3].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[4].pm1_0: "No data",
      day: moment(item.histories[4].date).format("dddd"),
      date: moment(item.histories[4].date).format("DD"),
      month: moment(item.histories[4].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[5].pm1_0: "No data",
      day: moment(item.histories[5].date).format("dddd"),
      date: moment(item.histories[5].date).format("DD"),
      month: moment(item.histories[5].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[6].pm1_0: "No data",
      day: moment(item.histories[6].date).format("dddd"),
      date: moment(item.histories[6].date).format("DD"),
      month: moment(item.histories[6].date).format("MMMM"),
    },
  ...
  const pm25 =[
    ...
    {
      value: item.histories.length > 0 ? item.histories[1].pm2_5: "No data",
      day: moment(item.histories[1].date).format("dddd"),
      date: moment(item.histories[1].date).format("DD"),
      month: moment(item.histories[1].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[2].pm2_5: "No data",
      day: moment(item.histories[2].date).format("dddd"),
      date: moment(item.histories[2].date).format("DD"),
      month: moment(item.histories[2].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[3].pm2_5: "No data",
      day: moment(item.histories[3].date).format("dddd"),
      date: moment(item.histories[3].date).format("DD"),
      month: moment(item.histories[3].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[4].pm2_5: "No data",
      day: moment(item.histories[4].date).format("dddd"),
      date: moment(item.histories[4].date).format("DD"),
      month: moment(item.histories[4].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[5].pm2_5: "No data",
      day: moment(item.histories[5].date).format("dddd"),
      date: moment(item.histories[5].date).format("DD"),
      month: moment(item.histories[5].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[6].pm2_5: "No data",
      day: moment(item.histories[6].date).format("dddd"),
      date: moment(item.histories[6].date).format("DD"),
      month: moment(item.histories[6].date).format("MMMM"),
    },
  ...
  const pm10 =[
    ...
    {
      value: item.histories.length > 0 ? item.histories[1].pm10_0: "No data",
      day: moment(item.histories[1].date).format("dddd"),
      date: moment(item.histories[1].date).format("DD"),
      month: moment(item.histories[1].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[2].pm10_0: "No data",
      day: moment(item.histories[2].date).format("dddd"),
      date: moment(item.histories[2].date).format("DD"),
      month: moment(item.histories[2].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[3].pm10_0: "No data",
      day: moment(item.histories[3].date).format("dddd"),
      date: moment(item.histories[3].date).format("DD"),
      month: moment(item.histories[3].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[4].pm10_0: "No data",
      day: moment(item.histories[4].date).format("dddd"),
      date: moment(item.histories[4].date).format("DD"),
      month: moment(item.histories[4].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[5].pm10_0: "No data",
      day: moment(item.histories[5].date).format("dddd"),
      date: moment(item.histories[5].date).format("DD"),
      month: moment(item.histories[5].date).format("MMMM"),
    },
    {
      value: item.histories.length > 0 ? item.histories[6].pm10_0: "No data",
      day: moment(item.histories[6].date).format("dddd"),
      date: moment(item.histories[6].date).format("DD"),
      month: moment(item.histories[6].date).format("MMMM"),
    },
